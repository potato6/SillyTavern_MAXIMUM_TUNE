...
export async function loadPowerUserSettings(settings, data) {
    ...
    (document.getElementById('single_line') as HTMLInputElement).checked = power_user.single_line;
    (document.getElementById('relaxed_api_urls') as HTMLInputElement).checked = power_user.relaxed_api_urls;
    (document.getElementById('world_import_dialog') as HTMLInputElement).checked = power_user.world_import_dialog;
    (document.getElementById('enable_auto_select_input') as HTMLInputElement).checked = power_user.enable_auto_select_input;
    (document.getElementById('enable_md_hotkeys') as HTMLInputElement).checked = power_user.enable_md_hotkeys;
    (document.getElementById('trim_spaces') as HTMLInputElement).checked = power_user.trim_spaces;
    (document.getElementById('continue_on_send') as HTMLInputElement).checked = power_user.continue_on_send;
    (document.getElementById('quick_continue') as HTMLInputElement).checked = power_user.quick_continue;
    (document.getElementById('quick_impersonate') as HTMLInputElement).checked = power_user.quick_continue;
    ...
    (document.getElementById('gestures-checkbox') as HTMLInputElement).checked = power_user.gestures;
    (document.getElementById('auto_swipe') as HTMLInputElement).checked = power_user.auto_swipe;
    ...
    (document.getElementById('custom_stopping_strings_macro') as HTMLInputElement).checked = power_user.custom_stopping_strings_macro;
    (document.getElementById('fuzzy_search_checkbox') as HTMLInputElement).checked = power_user.fuzzy_search;
    (document.getElementById('persona_show_notifications') as HTMLInputElement).checked = power_user.persona_show_notifications;
    (document.getElementById('persona_allow_multi_connections') as HTMLInputElement).checked = power_user.persona_allow_multi_connections;
    (document.getElementById('persona_auto_lock') as HTMLInputElement).checked = power_user.persona_auto_lock;
    (document.getElementById('encode_tags') as HTMLInputElement).checked = power_user.encode_tags;
    (document.getElementById('experimental_macro_engine') as HTMLInputElement).checked = power_user.experimental_macro_engine;
    ...
    (document.getElementById('console_log_prompts') as HTMLInputElement).checked = power_user.console_log_prompts;
    (document.getElementById('request_token_probabilities') as HTMLInputElement).checked = power_user.request_token_probabilities;
    (document.getElementById('show_group_chat_queue') as HTMLInputElement).checked = power_user.show_group_chat_queue;
    (document.getElementById('auto_fix_generated_markdown') as HTMLInputElement).checked = power_user.auto_fix_generated_markdown;
    (document.getElementById('auto_scroll_chat_to_bottom') as HTMLInputElement).checked = power_user.auto_scroll_chat_to_bottom;
    (document.getElementById('bogus_folders') as HTMLInputElement).checked = power_user.bogus_folders;
    ...
    (document.getElementById('collapse-newlines-checkbox') as HTMLInputElement).checked = power_user.collapse_newlines;
    (document.getElementById('always-force-name2-checkbox') as HTMLInputElement).checked = power_user.always_force_name2;
    (document.getElementById('trim_sentences_checkbox') as HTMLInputElement).checked = power_user.trim_sentences;
    (document.getElementById('disable_group_trimming') as HTMLInputElement).checked = power_user.disable_group_trimming;
    (document.getElementById('markdown_escape_strings') as HTMLInputElement).value = power_user.markdown_escape_strings;
    (document.getElementById('fast_ui_mode') as HTMLInputElement).checked = power_user.fast_ui_mode;
    (document.getElementById('waifuMode') as HTMLInputElement).checked = power_user.waifuMode;
    (document.getElementById('movingUImode') as HTMLInputElement).checked = power_user.movingUI;
    (document.getElementById('noShadowsmode') as HTMLInputElement).checked = power_user.noShadows;
    (document.getElementById('start_reply_with') as HTMLTextAreaElement).textContent = power_user.user_prompt_bias;
    (document.getElementById('chat-show-reply-prefix-checkbox') as HTMLInputElement).checked = power_user.show_user_prompt_bias;
    (document.getElementById('auto_continue_enabled') as HTMLInputElement).checked = power_user.auto_continue.enabled;
    (document.getElementById('auto_continue_allow_chat_completions') as HTMLInputElement).checked = power_user.auto_continue.allow_chat_completions;
    ...
    (document.getElementById('play_message_sound') as HTMLInputElement).checked = power_user.play_message_sound;
    (document.getElementById('play_sound_unfocused') as HTMLInputElement).checked = power_user.play_sound_unfocused;
    (document.getElementById('never_resize_avatars') as HTMLInputElement).checked = power_user.never_resize_avatars;
    (document.getElementById('show_card_avatar_urls') as HTMLInputElement).checked = power_user.show_card_avatar_urls;
    (document.getElementById('auto_save_msg_edits') as HTMLInputElement).checked = power_user.auto_save_msg_edits;
    (document.getElementById('allow_name1_display') as HTMLInputElement).checked = power_user.allow_name1_display;
    (document.getElementById('allow_name2_display') as HTMLInputElement).checked = power_user.allow_name2_display;
    //document.getElementById('removeXML')?.checked = power_user.removeXML;
    (document.getElementById('hotswapEnabled') as HTMLInputElement).checked = power_user.hotswap_enabled;
    (document.getElementById('messageTimerEnabled') as HTMLInputElement).checked = power_user.timer_enabled;
    (document.getElementById('messageTimestampsEnabled') as HTMLInputElement).checked = power_user.timestamps_enabled;
    (document.getElementById('messageModelIconEnabled') as HTMLInputElement).checked = power_user.timestamp_model_icon;
    (document.getElementById('mesIDDisplayEnabled') as HTMLInputElement).checked = power_user.mesIDDisplay_enabled;
    (document.getElementById('hideChatAvatarsEnabled') as HTMLInputElement).checked = power_user.hideChatAvatars_enabled;
    (document.getElementById('prefer_character_prompt') as HTMLInputElement).checked = power_user.prefer_character_prompt;
    (document.getElementById('prefer_character_jailbreak') as HTMLInputElement).checked = power_user.prefer_character_jailbreak;
    (document.getElementById('enableZenSliders') as HTMLInputElement).checked = power_user.enableZenSliders;
    (document.getElementById('enableZenSliders') as HTMLInputElement | null)?.dispatchEvent(new Event('input', { bubbles: true }));
    (document.getElementById('enableLabMode') as HTMLInputElement).checked = power_user.enableLabMode;
    ...
    (document.getElementById('stscript_autocomplete_autoHide') as HTMLInputElement).checked = power_user.stscript.autocomplete.autoHide ?? false;
    ...
    (document.getElementById('stscript_autocomplete_showInAllMacroFields') as HTMLInputElement).checked = power_user.stscript.autocomplete.showInAllMacroFields ?? false;
    ...
    (document.getElementById('stscript_parser_flag_strict_escaping') as HTMLInputElement).checked = power_user.stscript.parser.flags[PARSER_FLAG.STRICT_ESCAPING] ?? false;
    (document.getElementById('stscript_parser_flag_replace_getvar') as HTMLInputElement).checked = power_user.stscript.parser.flags[PARSER_FLAG.REPLACE_GETVAR] ?? false;
    ...
    (document.getElementById('restore_user_input') as HTMLInputElement).checked = power_user.restore_user_input;
    ...
    (document.getElementById('smooth_streaming') as HTMLInputElement).checked = power_user.smooth_streaming;
    (document.getElementById('smooth_streaming_no_think') as HTMLInputElement).checked = power_user.smooth_streaming_no_think;
    (document.getElementById('smooth_streaming_speed') as HTMLInputElement).value = String(power_user.smooth_streaming_speed);
    (document.getElementById('stream_fade_in') as HTMLInputElement).checked = power_user.stream_fade_in;
    ...
    (document.getElementById('reduced_motion') as HTMLInputElement).checked = power_user.reduced_motion;
    (document.getElementById('auto-connect-checkbox') as HTMLInputElement).checked = power_user.auto_connect;
    (document.getElementById('auto-load-chat-checkbox') as HTMLInputElement).checked = power_user.auto_load_chat;
    (document.getElementById('forbid_external_media') as HTMLInputElement).checked = power_user.forbid_external_media;
    (document.getElementById('pin_styles') as HTMLInputElement).checked = power_user.pin_styles;
    (document.getElementById('click_to_edit') as HTMLInputElement).checked = power_user.click_to_edit;
